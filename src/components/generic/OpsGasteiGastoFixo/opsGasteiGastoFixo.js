		...
		if (gastoFixo.opcoes) {
			return (
				<View style={STYLES.opcoes}>
					<TouchableOpacity style={STYLES.op} onPress={this.prepararEdicaoAtual}>
					...
					<TouchableOpacity style={STYLES.op} onPress={this.prepararEdicaoProximo}>
						<View style={STYLES.opItemContainer}>
							<OpsGasteiIcone icone="pencil" />
					...
					<TouchableOpacity style={STYLES.op} onPress={this.prepararExclusao}>
						<View style={STYLES.opItemContainer}>
